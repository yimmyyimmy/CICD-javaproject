...
*/
    ...
    stage('Deploy to Tomcat') {
      steps{
        ...
        {
        sh 'scp -o StrictHostKeyChecking=no /home/jenkins/workspace/javapipeline/target/SimpleWebApplication.war ec2@15.206.210.179:8080:/opt/apache-tomcat-10.1.30/webapps'
        }
 '
